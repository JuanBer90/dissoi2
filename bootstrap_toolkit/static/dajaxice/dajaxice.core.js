...
var Dajaxice = {
    ...
    args_example: function(callback_function, argv, custom_settings){
        return Dajaxice.call('asientos_contables.args_example', 'POST', callback_function, argv, custom_settings);
    },

    existe_cambio: function(callback_function, argv, custom_settings){
        return Dajaxice.call('asientos_contables.existe_cambio', 'POST', callback_function, argv, custom_settings);
    }
